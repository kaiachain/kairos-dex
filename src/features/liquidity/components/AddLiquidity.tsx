...
export function AddLiquidity({
  ...
  const isFirstLiquidity = Boolean(isPoolInitialized && poolLiquidity !== undefined && poolLiquidity !== null && poolLiquidity === BigInt(0) && !isLoadingLiquidity);
  ...
  return (
    <div className="bg-white dark:bg-card rounded-3xl shadow-lg p-6 border border-border w-full">
      ...
      <div className="space-y-6">
        ...
        {isFirstLiquidity === true && token0 && token1 && amount0 && amount0 !== '0' && amount1 && amount1 !== '0' && (sqrtPriceX96 !== undefined && sqrtPriceX96 !== null && sqrtPriceX96 !== BigInt(0)) && currentTick !== null && (
